...
const Description = tw.p`mt-6 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-indigo-900`
...
const StarIcon = tw(
  StarIconBase,
)`inline-block w-5 h-5 text-yellow-400 fill-current mr-1 last:mr-0`
...
const CustomerTitle = tw.p`font-medium text-indigo-100`
...
const ControlButton = styled.button`
  ${tw`mx-3 p-4 rounded-full transition duration-300 bg-gray-200 hover:bg-gray-300 text-primary-500 hover:text-primary-700 focus:outline-none focus:shadow-xl`}
  svg {
    ${tw`w-4 h-4 stroke-2`}
  }
`
